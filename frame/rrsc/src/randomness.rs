...
/// than both other randomness sources provided by RRSC, but `ParentBlockRandomness`
...
/// a RRSC-like approach that derives its `ParentBlockRandomness`, and authorizes block
